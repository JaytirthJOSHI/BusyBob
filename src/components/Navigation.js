    ...
    return `
      <div class="max-w-screen-xl mx-auto px-4">
        <div class="flex justify-between">
          ...
          ${localStorage.getItem('showGradesTab') !== 'false' ? `
          ...
          <a href="#" data-page="canvas" class="nav-link flex-1 flex flex-col items-center py-2 sm:py-3 text-gray-600 hover:text-blue-500 dark:text-gray-400 dark:hover:text-blue-400 transition-colors">
            <svg class="w-5 h-5 sm:w-6 sm:h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
